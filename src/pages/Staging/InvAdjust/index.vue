  ...
  data () {
    return {
      links: [
        {
          label: '新建库存调整',
          Subrouter: '/Inv/InvAdjustList',
          AuthName: 'InventoryAdjustCreate'
        },
        {
          label: '库存调整查询',
          Subrouter: '/Inv/InvAdjustSelect',
          AuthName: 'InventoryAdjustQuery'
        },
        {
          label: '库存调整审批',
          Subrouter: '/Inv/InvAdjustApvList',
          AuthName: 'InventoryAdjustApproval'
        }
      ]
    }
  },
  created () {
    this.CHANGE_TITLE('库存调整')
